...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Approver</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.ApproverImpl#getDocuments <em>Documents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ApproverImpl extends DocumentPersonRoleImpl implements Approver {
    /**
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getApprover();
    }
    ...
    public EList< Document > getDocuments() {
        if( documents == null ) {
            documents = new EObjectWithInverseResolvingEList.Unsettable< Document >( Document.class, this,
                    CimPackage.APPROVER__DOCUMENTS, CimPackage.DOCUMENT__APPROVER );
        }
        return documents;
    }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.APPROVER__DOCUMENTS:
