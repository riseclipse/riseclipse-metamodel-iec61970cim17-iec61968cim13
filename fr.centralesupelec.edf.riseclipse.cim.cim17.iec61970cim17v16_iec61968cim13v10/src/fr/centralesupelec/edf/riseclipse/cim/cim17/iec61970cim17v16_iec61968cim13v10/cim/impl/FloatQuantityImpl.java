 ...
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.FloatQuantityImpl#getMultiplier <em>Multiplier</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.FloatQuantityImpl#getUnit <em>Unit</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.FloatQuantityImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FloatQuantityImpl extends MinimalEObjectImpl.Container implements FloatQuantity {
    ...
    public void setMultiplier( UnitMultiplier newMultiplier ) {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.SET,
                CimPackage.FLOAT_QUANTITY__MULTIPLIER, oldMultiplier, multiplier, !oldMultiplierESet ) );
    }
    ...
    public void unsetMultiplier() {
        ...
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.UNSET,
                CimPackage.FLOAT_QUANTITY__MULTIPLIER, oldMultiplier, MULTIPLIER_EDEFAULT, oldMultiplierESet ) );
    }
    ...
    public void setUnit( UnitSymbol newUnit ) {
        ...
        unitESet = true;
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.SET,
                CimPackage.FLOAT_QUANTITY__UNIT, oldUnit, unit, !oldUnitESet ) );
    }
    ...
    public void unsetUnit() {
        ...
        unitESet = false;
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.UNSET,
                CimPackage.FLOAT_QUANTITY__UNIT, oldUnit, UNIT_EDEFAULT, oldUnitESet ) );
    }
    ...
    public void setValue( Float newValue ) {
        ...
        valueESet = true;
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.SET,
                CimPackage.FLOAT_QUANTITY__VALUE, oldValue, value, !oldValueESet ) );
    }
    ...
    public void unsetValue() {
        ...
        valueESet = false;
        if( eNotificationRequired() ) eNotify( new ENotificationImpl( this, Notification.UNSET,
                CimPackage.FLOAT_QUANTITY__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet ) );
    }
