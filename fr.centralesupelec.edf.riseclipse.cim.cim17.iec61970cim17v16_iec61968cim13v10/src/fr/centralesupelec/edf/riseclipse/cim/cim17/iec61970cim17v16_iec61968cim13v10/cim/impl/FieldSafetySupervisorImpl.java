...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Field Safety Supervisor</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.FieldSafetySupervisorImpl#getIssuedSafetyDocuments <em>Issued Safety Documents</em>}</li>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.FieldSafetySupervisorImpl#getReleasedSafetyDocuments <em>Released Safety Documents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FieldSafetySupervisorImpl extends CrewMemberImpl implements FieldSafetySupervisor {
    /**
     ...
     * @generated
     */
    protected FieldSafetySupervisorImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getFieldSafetySupervisor();
    }
    ...
    public EList< SafetyDocument > getIssuedSafetyDocuments() {
        if( issuedSafetyDocuments == null ) {
            issuedSafetyDocuments = new EObjectWithInverseResolvingEList.Unsettable< SafetyDocument >(
                    SafetyDocument.class, this, CimPackage.FIELD_SAFETY_SUPERVISOR__ISSUED_SAFETY_DOCUMENTS,
                    CimPackage.SAFETY_DOCUMENT__ISSUED_TO_SUPERVISOR );
        }
    ...
    public EList< SafetyDocument > getReleasedSafetyDocuments() {
        if( releasedSafetyDocuments == null ) {
            releasedSafetyDocuments = new EObjectWithInverseResolvingEList.Unsettable< SafetyDocument >(
                    SafetyDocument.class, this, CimPackage.FIELD_SAFETY_SUPERVISOR__RELEASED_SAFETY_DOCUMENTS,
                    CimPackage.SAFETY_DOCUMENT__RELEASED_BY_SUPERVISOR );
        }
    ...
    public NotificationChain eInverseAdd( InternalEObject otherEnd, int featureID, NotificationChain msgs ) {
        switch( featureID ) {
        case CimPackage.FIELD_SAFETY_SUPERVISOR__ISSUED_SAFETY_DOCUMENTS:
            return ( ( InternalEList< InternalEObject > ) ( InternalEList< ? > ) getIssuedSafetyDocuments() )
                    .basicAdd( otherEnd, msgs );
        case CimPackage.FIELD_SAFETY_SUPERVISOR__RELEASED_SAFETY_DOCUMENTS:
