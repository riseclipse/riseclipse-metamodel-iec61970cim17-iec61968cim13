...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Equipment Fault</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.EquipmentFaultImpl#getTerminal <em>Terminal</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquipmentFaultImpl extends FaultImpl implements EquipmentFault {
    /**
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getEquipmentFault();
    }
    ...
    public NotificationChain basicSetTerminal( Terminal newTerminal, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.EQUIPMENT_FAULT__TERMINAL, oldTerminal, newTerminal, !oldTerminalESet );
            if( msgs == null )
                msgs = notification;
            else
    ...
    public NotificationChain basicUnsetTerminal( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.EQUIPMENT_FAULT__TERMINAL, oldTerminal, null, oldTerminalESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
