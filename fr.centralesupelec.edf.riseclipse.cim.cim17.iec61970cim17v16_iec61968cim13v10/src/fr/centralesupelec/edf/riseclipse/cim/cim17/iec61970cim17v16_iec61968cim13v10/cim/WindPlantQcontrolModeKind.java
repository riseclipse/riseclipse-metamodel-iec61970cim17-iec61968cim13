 ...
 * <!-- end-user-doc -->
 * @see fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.CimPackage#getWindPlantQcontrolModeKind()
 * @model
 * @generated
 */
public enum WindPlantQcontrolModeKind implements Enumerator {
     ...
     * <!-- begin-user-doc -->
     * <p>
     * If the meaning of '<em><b>Uq Static</b></em>' literal object isn't clear,
     * there really should be more of a description here...
     * </p>
     * <!-- end-user-doc -->
     * @see #UQ_STATIC
     ...
     * @generated
     */
    private static final WindPlantQcontrolModeKind[] VALUES_ARRAY = new WindPlantQcontrolModeKind[] { REACTIVE_POWER,
            POWER_FACTOR, UQ_STATIC, VOLTAGE_CONTROL, };
    ...
    public static WindPlantQcontrolModeKind get( String literal ) {
        for( int i = 0; i < VALUES_ARRAY.length; ++i ) {
            WindPlantQcontrolModeKind result = VALUES_ARRAY[i];
