...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Gen Unit Op Schedule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.impl.GenUnitOpScheduleImpl#getGeneratingUnit <em>Generating Unit</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GenUnitOpScheduleImpl extends RegularIntervalScheduleImpl implements GenUnitOpSchedule {
    /**
     ...
     * @generated
     */
    protected GenUnitOpScheduleImpl() {
        super();
    }
    ...
    protected EClass eStaticClass() {
        return CimPackage.eINSTANCE.getGenUnitOpSchedule();
    }
    ...
    public NotificationChain basicSetGeneratingUnit( GeneratingUnit newGeneratingUnit, NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.SET,
                    CimPackage.GEN_UNIT_OP_SCHEDULE__GENERATING_UNIT, oldGeneratingUnit, newGeneratingUnit,
    ...
    public NotificationChain basicUnsetGeneratingUnit( NotificationChain msgs ) {
        ...
        if( eNotificationRequired() ) {
            ENotificationImpl notification = new ENotificationImpl( this, Notification.UNSET,
                    CimPackage.GEN_UNIT_OP_SCHEDULE__GENERATING_UNIT, oldGeneratingUnit, null, oldGeneratingUnitESet );
            if( msgs == null )
                msgs = notification;
            else
                msgs.add( notification );
