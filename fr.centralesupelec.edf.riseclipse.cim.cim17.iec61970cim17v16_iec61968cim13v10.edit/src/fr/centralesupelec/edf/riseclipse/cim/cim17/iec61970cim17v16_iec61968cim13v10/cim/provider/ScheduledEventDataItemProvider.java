...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.ScheduledEventData} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ScheduledEventDataItemProvider extends CimObjectWithIDItemProvider {
    ...
    public List< IItemPropertyDescriptor > getPropertyDescriptors( Object object ) {
        if( itemPropertyDescriptors == null ) {
            ...
            addInspectionDataSetPropertyDescriptor( object );
        }
    ...
    /**
     * This adds a property descriptor for the Inspection Data Set feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( CimPackage.eINSTANCE.getScheduledEventData_EstimatedWindow() );
            childrenFeatures.add( CimPackage.eINSTANCE.getScheduledEventData_RequestedWindow() );
            childrenFeatures.add( CimPackage.eINSTANCE.getScheduledEventData_Status() );
        }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( ScheduledEventData.class ) ) {
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getScheduledEventData_EstimatedWindow(),
                CimFactory.eINSTANCE.createDateTimeInterval() ) );

        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getScheduledEventData_RequestedWindow(),
                CimFactory.eINSTANCE.createDateTimeInterval() ) );

        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getScheduledEventData_Status(),
