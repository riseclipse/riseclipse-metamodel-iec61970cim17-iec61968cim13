...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.StreetAddress} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StreetAddressItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( CimPackage.eINSTANCE.getStreetAddress_Status() );
            childrenFeatures.add( CimPackage.eINSTANCE.getStreetAddress_StreetDetail() );
            childrenFeatures.add( CimPackage.eINSTANCE.getStreetAddress_TownDetail() );
        }
    ...
    public String getText( Object object ) {
        String label = ( ( StreetAddress ) object ).getPoBox();
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getStreetAddress_Status(),
                CimFactory.eINSTANCE.createStatus() ) );

        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getStreetAddress_StreetDetail(),
                CimFactory.eINSTANCE.createStreetDetail() ) );

        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getStreetAddress_TownDetail(),
                CimFactory.eINSTANCE.createTownDetail() ) );
    }
