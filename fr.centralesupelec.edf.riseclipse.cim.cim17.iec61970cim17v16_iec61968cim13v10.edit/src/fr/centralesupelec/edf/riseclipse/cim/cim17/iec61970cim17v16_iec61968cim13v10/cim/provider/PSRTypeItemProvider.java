...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.PSRType} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PSRTypeItemProvider extends IdentifiedObjectItemProvider {
    /**
     ...
     * @generated
     */
    public PSRTypeItemProvider( AdapterFactory adapterFactory ) {
    ...
    public Object getImage( Object object ) {
        return overlayImage( object, getResourceLocator().getImage( "full/obj16/PSRType" ) );
    }
    ...
    public String getText( Object object ) {
        String label = ( ( PSRType ) object ).getName();
        return label == null || label.length() == 0 ? getString( "_UI_PSRType_type" )
                : getString( "_UI_PSRType_type" ) + " " + label;
    }
