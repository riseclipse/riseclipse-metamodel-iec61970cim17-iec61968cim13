...
/**
 * This is the item provider adapter for a {@link fr.centralesupelec.edf.riseclipse.cim.cim17.iec61970cim17v16_iec61968cim13v10.cim.OperationalRestriction} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OperationalRestrictionItemProvider extends DocumentItemProvider {
    ...
    public Collection< ? extends EStructuralFeature > getChildrenFeatures( Object object ) {
        if( childrenFeatures == null ) {
            ...
            childrenFeatures.add( CimPackage.eINSTANCE.getOperationalRestriction_ActivePeriod() );
            childrenFeatures.add( CimPackage.eINSTANCE.getOperationalRestriction_RestrictedValue() );
        }
    ...
    public void notifyChanged( Notification notification ) {
        ...
        switch( notification.getFeatureID( OperationalRestriction.class ) ) {
    ...
    protected void collectNewChildDescriptors( Collection< Object > newChildDescriptors, Object object ) {
        ...
        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getOperationalRestriction_ActivePeriod(),
                CimFactory.eINSTANCE.createDateTimeInterval() ) );

        newChildDescriptors.add( createChildParameter( CimPackage.eINSTANCE.getOperationalRestriction_RestrictedValue(),
